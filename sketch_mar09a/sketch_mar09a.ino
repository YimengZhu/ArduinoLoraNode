...
static const PROGMEM u1_t NWKSKEY[16] = { 0x55, 0x6D, 0xF1, 0xE4, 0x13, 0xF1, 0x3C, 0x42, 0xD2, 0x5D, 0xA3, 0x7E, 0x13, 0x54, 0xDD, 0x83 };
static const u1_t PROGMEM APPSKEY[16] = { 0xA1, 0x2A, 0xE7, 0x3D, 0xE1, 0xFC, 0x68, 0x83, 0x8A, 0xC9, 0x88, 0x81, 0x77, 0x9F, 0x5C, 0x8A };
static const u4_t DEVADDR = 0x2601104F ; // <-- Change this address for every node!
